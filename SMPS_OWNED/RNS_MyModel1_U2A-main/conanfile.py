...
class MyModelConan(ConanFile):
    name = "rns_mymodel1_u2a"
    version = "2.0.0"
    tlmc = 'RNS_MyModel1_U2A'
    
    # Optional metadata
    description = "A short description of the package"
    topics = ("c++", "library")
    homepage = "https://github.com/snps-ssw/RNS_MyModel1_U2A.git"
    url = "https://github.com/snps-ssw/RNS_MyModel1_U2A.git"
    license = "MIT"
    ...
    def layout(self):
        self.folders.build = "../b/IP/RNS/U2A/MyModel1"
        self.folders.generators = "../b"
        self.folders.package = "package"
        self.folders.bin = "../IP/RNS/U2A/MyModel1"
        self.folders.source = "."
    ...
    def source(self):
        """Get the source code"""
        git = Git(self)
        git.clone(url="https://github.com/snps-ssw/RNS_MyModel1_U2A.git")
